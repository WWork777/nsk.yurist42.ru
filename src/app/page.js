...
export const metadata = {
  ...
  description:
    "Профессиональные юридические услуги в Новосибирске. Решение сложных вопросов, судебное сопровождение, защита прав. Бесплатная консультация.",
  keywords:
    "юрист Новосибирск, юридическая помощь, консультация юриста, судебные споры",
  alternates: {
    canonical: `https://nsk.yurist42.ru/`,
  },
  openGraph: {
    title: `Юрист Новосибирск | Юридическая компания Кодексъ`,
    description: `Профессиональные юридические услуги в Новосибирске. Решение сложных вопросов, судебное сопровождение, защита прав. Бесплатная консультация.`,
